...
import CreateGossipFloatingButton from "../profile/CreateGossipFloatingButton";
...
export default function NavSection({
  ...
  return (
    <section>
      <NavBar />
      <div className="w-full fixed bottom-0 left-0 flex items-center justify-center p-4 px-6 z-40">
        <div className="w-full max-w-[800px] flex items-center justify-end">
          <CreateGossipFloatingButton />
        </div>
      </div>
